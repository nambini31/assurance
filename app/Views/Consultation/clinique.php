                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-content collapse show">
                            ...
                            <form method="POST" id="add_clinique" >
                            <input type="hidden" name="idDetailsCons" class="idDetailsCons">

                                 
                            <table id="table_clinique_vrai" class="table table-white-space table-bordered table-sm no-wrap  text-center" style="width: 100% !important; overflow: auto;">
