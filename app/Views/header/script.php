...
<script src="<?php echo base_url() ?>/assets/js/tables/datatable/dataTables.bootstrap4.min.js"></script>
<script src="<?php echo base_url() ?>/assets/js/tables/datatable/dataTables.buttons.min.js"></script>
...
<script src="<?php echo base_url() ?>/assets/js/forms/icheck.min.js"></script>
