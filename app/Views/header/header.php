<nav class="header-navbar navbar-expand-md navbar navbar-with-menu navbar-without-dd-arrow fixed-top navbar-semi-dark" style="background-color: #05d363 !important;
        ...
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item"><a class="navbar-brand" href="#">
                        ...
                        <h3 class="brand-text" style="margin-top: 10px;"><img class="brand-logo" style="width: 90px;" alt="modern admin logo" src="<?php echo base_url() ?>/assets/logo/logo.png"></h3>
                    </a></li>
