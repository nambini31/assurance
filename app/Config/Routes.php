...
// $routes->get('/', 'Article\ArticleCont::index');
    ...
    $routes->post('affiche_conclusion', 'consultation\ConsultationCont::affiche_conclusion');
    $routes->post('affiche_clinique', 'consultation\ConsultationCont::affiche_clinique');
    $routes->post('affiche_autreacte', 'consultation\ConsultationCont::affiche_autreacte');
    ...
    $routes->post('annuler_acte', 'consultation\ConsultationCont::annuler_acte');
    $routes->post('add_autreacte', 'consultation\ConsultationCont::add_autreacte');
    $routes->post('add_antecedent', 'consultation\ConsultationCont::add_antecedent');
