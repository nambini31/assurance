...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 14 août 2024 à 09:22
...
--
CREATE DATABASE IF NOT EXISTS `assurance` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `assurance`;
...
CREATE TABLE `cabinet` (
  ...
  `nom_cabinet` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `consultation` (
  ...
  `typeConsultationId` int NOT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` date DEFAULT NULL,
  `isFinished` int NOT NULL DEFAULT '0' COMMENT '0 : encours ;\r\n1 : terminée'
...
DROP TABLE IF EXISTS `detailconsultation`;
CREATE TABLE `detailconsultation` (
  `detailConsultationId` int NOT NULL,
  `consultationId` int NOT NULL,
  `motif` text COLLATE utf8mb4_general_ci,
  `personneMalade` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT 'titulaire ; conjointe ; enfant',
  `nomPersonneMalade` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `etat` int NOT NULL COMMENT '0:supprimé ; 1:non supprimé',
  ...
  `tension` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `poids` varchar(10) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `douleur` text COLLATE utf8mb4_general_ci NOT NULL,
  `descriptionDouleur` text COLLATE utf8mb4_general_ci,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
DROP TABLE IF EXISTS `detailmedicament`;
CREATE TABLE `detailmedicament` (
  `detailMedicamentId` int NOT NULL,
  `medicamentId` int NOT NULL,
  `nombre` int NOT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `matin` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `midi` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `soir` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `enfant` (
  ...
  `tiitulaireId` int NOT NULL,
  `nom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `prenom` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `genre` varchar(6) COLLATE utf8mb4_general_ci NOT NULL,
  `dateNaiss` date DEFAULT NULL,
  `isActif` int NOT NULL DEFAULT '1' COMMENT '0 : ne doit plus profité à cause du limite d''age .\r\n1 : doit profité(-20)',
  `etat` int NOT NULL DEFAULT '1' COMMENT '0 : supprimé ;\r\n1 : non supprimé',
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `medecin` (
  ...
  `nom_medecin` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `membre` (
  ...
  `contact_membre` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `email_membre` varchar(100) COLLATE utf8mb4_general_ci NOT NULL,
  `description` text COLLATE utf8mb4_general_ci,
  `ispaye` tinyint(1) NOT NULL DEFAULT '1',
  `motifBloque` text COLLATE utf8mb4_general_ci,
...
CREATE TABLE `patient` (
  ...
  `numero_patient` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
...
DROP TABLE IF EXISTS `rapportexamenmedical`;
CREATE TABLE `rapportexamenmedical` (
  `ExamenId` int NOT NULL,
  `etablissement` text COLLATE utf8mb4_general_ci,
  `genre` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nomPrenom` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dateNaiss` date DEFAULT NULL,
  `profession` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `adresse` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dateExamen` date DEFAULT NULL,
  `docteurExamen` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `poids` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `taille` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TAG` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `IMC` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `TAD` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `avantCorrectionOD` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `avantCorrectionOG` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apresCorrectionOD` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `apresCorrectionOG` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `acuiteAuditive` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `antecedentMedicauxPersonnels` longtext COLLATE utf8mb4_general_ci,
  `antecedentMedicauxFamiliaux` tinytext COLLATE utf8mb4_general_ci,
  `antecedentChirurgicaux` longtext COLLATE utf8mb4_general_ci,
  `antecedentGynecoObsetrique` longtext COLLATE utf8mb4_general_ci,
  `aspectSainAgeIndique` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `malformationMutilations` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesAspectGeneral` text COLLATE utf8mb4_general_ci,
  `goitre` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `languePharynxAmygdalesAnormale` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `affectionYeux` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `affectionAuditif` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentaireORL_OPHTALMOLOGIE` longtext COLLATE utf8mb4_general_ci,
  `affectionBuccoDentaire` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `etatDentaire` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentaireStomatologieque` longtext COLLATE utf8mb4_general_ci,
  `respiratoireLimite` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `percussionAnormales` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ausculationAnormaux` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `voixVoilee` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesRespiratoire` longtext COLLATE utf8mb4_general_ci,
  `bruitsCoeuModifie` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `souffleCardiaque` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `poulesInferieursPercus` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `souffleArteresCervicales` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesCardioVasculaire` longtext COLLATE utf8mb4_general_ci,
  `palpationPathologique` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hepatomegalie` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `splenomegalie` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hernie` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `hemorroide` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesDigestif` longtext COLLATE utf8mb4_general_ci,
  `alcoolismeTabagisme` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `antecedentsOrganesGenito` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `indicesAffectionOrganesGenitauxM` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `gynecomastie` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `indicesAffectionOrganesGenitauxF` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `modificationAnormalSeins` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesGenitoUrinaire` longtext COLLATE utf8mb4_general_ci,
  `urineAspect` longtext COLLATE utf8mb4_general_ci,
  `urineAlbumine` longtext COLLATE utf8mb4_general_ci,
  `urineGlucose` longtext COLLATE utf8mb4_general_ci,
  `urineLEU` longtext COLLATE utf8mb4_general_ci,
  `urineNIT` longtext COLLATE utf8mb4_general_ci,
  `urineSG` longtext COLLATE utf8mb4_general_ci,
  `urinePH` longtext COLLATE utf8mb4_general_ci,
  `urinePRO` longtext COLLATE utf8mb4_general_ci,
  `urineKET` longtext COLLATE utf8mb4_general_ci,
  `urineURO` longtext COLLATE utf8mb4_general_ci,
  `reflexePupillaires` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `signesDystonie` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `troublesPsychique` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesSystemeNerveux` longtext COLLATE utf8mb4_general_ci,
  `ictereCyanose` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `eruptionUlcerationKyste` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `ganglionsLymphatiques` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `cicatricesTatouages` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `tophusXanthome` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairespeau` longtext COLLATE utf8mb4_general_ci,
  `affectionOs` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesSquelette` longtext COLLATE utf8mb4_general_ci,
  `repercussionProffessionelles` varchar(4) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `commentairesRepercussionProfessionnelles` longtext COLLATE utf8mb4_general_ci,
  `etatSanteConsidere` varchar(45) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `remarquesSpeciales` longtext COLLATE utf8mb4_general_ci,
  `villeExamen` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAt` datetime DEFAULT NULL,
  `updatedAt` datetime DEFAULT NULL,
  `etatExamen` int NOT NULL DEFAULT '0' COMMENT '0:enttente validation docteur; 1: validée;',
  `isDeleted` int NOT NULL DEFAULT '1' COMMENT '0: supprimé; 1:nom'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(9, 'GMS', 'Mlle', 'biby Be', '2024-07-19', 'Agent de Sécurité', 'yu', '2024-07-21', 'Dr Julia', '63.6 00 kg', '1.70 m', '10.6', '', '11.5', '10', '10', '8', '8', 'Bonne', 'dfdf dfdf On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même. L\'avantage du Lorem Ipsum sur un texte générique comme \'Du texte. Du texte. Du texte.\' est qu\'il possède une distribution de lettres plus ou moins normale, et en tout cas comparable avec celle du français standard. De nombreuses suites logicielles de mise en page ou éditeurs de sites Web ont fait du Lorem Ipsum leur faux texte par défaut, et une recherche pour \'Lorem Ipsum\' vous conduira vers de nombreux sites qui n\'en sont encore qu\'à leur phase de construction. Plusieurs versions sont apparues avec le temps, parfois par accident, souvent intentionnellement (histoire d\'y rajouter de petits clins d\'oeil, voire des phrases embarassantes).', 'dfdf dfdf ', 'dfdf dfdf On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même. L\'avantage du Lorem Ipsum sur un texte générique comme \'Du texte. Du texte. Du texte.\' est qu\'il possède une distribution de lettres plus ou moins normale, et en tout cas comparable avec celle du français standard. De nombreuses suites logicielles de mise en page ou éditeurs de sites Web ont fait du Lorem Ipsum leur faux texte par défaut, et une recherche pour \'Lorem Ipsum\' vous conduira vers de nombreux sites qui n\'en sont encore qu\'à leur phase de construction. Plusieurs versions sont apparues avec le temps, parfois par accident, souvent intentionnellement (histoire d\'y rajouter de petits clins d\'oeil, voire des phrases embarassantes).', 'fdf dfdf', 'Oui', 'Oui', 'fdfdf dfdf On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même. L\'avantage du Lorem Ipsum sur un texte générique comme \'Du texte. Du texte. Du texte.\' est qu\'il possède une distribution de lettres plus ou moins normale, et en tout cas comparable avec celle du français standard. De nombreuses suites logicielles de mise en page ou éditeurs de sites Web ont fait du Lorem Ipsum leur faux texte par défaut, et une recherche pour \'Lorem Ipsum\' vous conduira vers de nombreux sites qui n\'en sont encore qu\'à leur phase de construction. Plusieurs versions sont apparues avec le temps, parfois par accident, souvent intentionnellement (histoire d\'y rajouter de petits clins d\'oeil, voire des phrases embarassantes).', 'Oui', 'Oui', 'Oui', 'Oui', 'dfdf dfdfdf On sait depuis longtemps que travailler avec du texte lisible et contenant du sens est source de distractions, et empêche de se concentrer sur la mise en page elle-même. L\'avantage du Lorem Ipsum sur un texte générique comme \'Du texte. Du texte. Du texte.\' est qu\'il possède une distribution de lettres plus ou moins normale, et en tout cas comparable avec celle du français standard. De nombreuses suites logicielles de mise en page ou éditeurs de sites Web ont fait du Lorem Ipsum leur faux texte par défaut, et une recherche pour \'Lorem Ipsum\' vous conduira vers de nombreux sites qui n\'en sont encore qu\'à leur phase de construction. Plusieurs versions sont apparues avec le temps, parfois par accident, souvent intentionnellement (histoire d\'y rajouter de petits clins d\'oeil, voire des phrases embarassantes).', 'Oui', NULL, 'dfdf ddfdf', 'Oui', 'Oui', 'Oui', 'Oui', 'fdfd dfdf', 'Oui', 'Oui', 'Oui', 'Oui', '', 'Oui', 'Oui', 'Oui', 'Oui', 'Oui', 'dfdf dfdf', 'Oui', 'Oui', 'Oui', 'Oui', 'Oui', 'Oui', 'dfdfd dfdfdf', 'doire', 'Nég', 'Nég', '2+', 'Nég', '1.020', '6', 'Nég', 'Nég', 'Nég', 'Oui', 'Oui', 'Oui', 'SYSTEME NERVEUX', 'Oui', 'Oui', 'Oui', 'Oui', 'Oui', 'PEAU', 'Oui', '', 'Oui', '', 'BON', 'REMARQUES SPECIALES ET SUGGESTIONS DU MEDCIN\r\n', 'Tana', '2024-07-21 03:42:22', '2024-08-11 17:15:04', 0, 1),
...
(15, 'GMS', 'Mlle', 'bibyBe', '0000-00-00', '', '', '2024-07-30', '', '', '', '', '', '', '', '', '', '', 'Bonne', '', '', '', '', 'Oui', NULL, '', NULL, NULL, NULL, NULL, '', NULL, NULL, '', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, '', NULL, '', NULL, '', NULL, '', '', '2024-07-30 09:57:39', '2024-08-11 10:30:03', 0, 1);
...
CREATE TABLE `specialite` (
  `id_specialite` int NOT NULL,
  `nom_specialite` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `etat` int NOT NULL DEFAULT '1' COMMENT '1 : actif\r\n0 : inactif',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `titulaire` (
  ...
  `numCarte` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `nom` varchar(50) COLLATE utf8mb4_general_ci NOT NULL,
  `prenom` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `genre` varchar(6) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `isActif` int NOT NULL DEFAULT '1' COMMENT '0 : ne doit plus profiteé ; \r\n1 : doit profité',
  `etat` int NOT NULL DEFAULT '1' COMMENT '0:supprimé ;\r\n1: non supprimé',
  `email` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nomPrenomConjoint` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `dateNaissConjoint` date DEFAULT NULL,
  `telephoneConjoint` varchar(50) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `genreConjoint` varchar(6) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `utilisateur` (
  ...
  `nom_user` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `prenom_user` varchar(255) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `mdp_user` varchar(255) COLLATE utf8mb4_general_ci NOT NULL,
  `roleId` int NOT NULL,
  `idTypeMedecin` int DEFAULT NULL,
...
--
ALTER TABLE `cabinet`
  MODIFY `id_cabinet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `consultation`
--
ALTER TABLE `consultation`
  MODIFY `consultationId` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `detailconsultation`
--
ALTER TABLE `detailconsultation`
  MODIFY `detailConsultationId` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `detailmedicament`
--
ALTER TABLE `detailmedicament`
  MODIFY `detailMedicamentId` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `docteur`
--
ALTER TABLE `docteur`
  MODIFY `docteurId` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `enfant`
--
ALTER TABLE `enfant`
  MODIFY `enfantId` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `medecin`
--
ALTER TABLE `medecin`
  MODIFY `id_medecin` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `membre`
--
ALTER TABLE `membre`
  MODIFY `id_membre` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `rapportexamenmedical`
  MODIFY `ExamenId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `specialite`
  MODIFY `id_specialite` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `titulaire`
--
ALTER TABLE `titulaire`
  MODIFY `titulaireId` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `typemedecin`
--
ALTER TABLE `typemedecin`
  MODIFY `idTypeMedecin` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
